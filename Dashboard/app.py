...
with st.expander("Section 3 — FX Decomposition" if has_fx else "Section 3 — Ratio & Basis", expanded=False):
...
with st.expander("Section 4 — Advanced Analytics", expanded=False):
